...
var palette = 0
export (String, "Shrew", "Bird", "Frog", "Turt", 
"Wasp", "Mant", "Slug", "Spid", "Fungus") var species = "Shrew"
...
func set_aminal(instance):
	...
	aminal_sprite = instance.get_node("AnimatedSprite").duplicate()
...
func set_palette(new_palette):
	palette = new_palette
	aminal_sprite.material.set_shader_param("palette", palette)
